...
include("ConexionMySQL.php");
    ...
    //$result = mysqli_query($con, "SELECT LATITUD,LONGITUD,FECHA_HORA,PESO_TOTAL  FROM $_SESSION[user] WHERE FECHA_HORA between '$fecha_hora_serv' and '2017-05-19 23:59:59'");

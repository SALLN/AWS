...
if ($_POST['Cargo']=="admin"){
	$consulta=mysql_query("SELECT LATITUD,LONGITUD,FECHA_HORA,PESO_TOTAL FROM $_POST[Usuario] WHERE ID_VEHICULO='$_POST[Vehiculo]' ORDER BY ID DESC LIMIT 1 ") or die("Problemas en consulta: ".mysql_error());
	...
	$user = $reg['user'];
	$consulta3=mysql_query("SELECT LATITUD,LONGITUD,FECHA_HORA,PESO_TOTAL FROM $user WHERE ID_VEHICULO='$_POST[Vehiculo]' ORDER BY ID DESC LIMIT 1 ") or die("Problemas en consulta: ".mysql_error());

...
$consulta=mysql_query("SELECT LATITUD,LONGITUD,FECHA_HORA,ID_VEHICULO FROM coordenadas where id=1",$con_aws);
...
mysql_query("INSERT INTO coordenadas2 (LATITUD,LONGITUD,FECHA_HORA,ID_VEHICULO) 
